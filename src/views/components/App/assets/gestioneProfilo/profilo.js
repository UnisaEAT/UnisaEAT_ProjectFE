...
import '../componentsCss/profilo.css';
          ...
          <div className="AreaPersonale">
            ...
            <Form className="test" onSubmit={this.onSubmit}>
              ...
              <div id="inputOldPassword">
                ...
                <Form.Control className="control" type="password" name="inputOldPassword" id="inputOldPassword" onChange={this.onChangeinputOldPassword} placeholder="Inserisci la tua vecchia assword"/>
              </div>

              <div id="inputPassword">
                <Form.Label className="label">Nuova Password</Form.Label>
                <Form.Control className="control" type="password" name="inputPassword" id="inputPassword" onChange={this.onChangeinputPassword} placeholder="Inserisci la tua nuova Password"/>
              </div>

              <div id="inputConfirmPassword">
                <Form.Label className="label">Conferma Nuova Password</Form.Label>
                <Form.Control className="control" type="password" name="inputConfirmPassword" id="inputConfirmPassword" onChange={this.onChangeConfirminputPassword} placeholder="Inserisci di nuovo la nuova Password"/>
              </div>
             ...
             <div id="root">
              ...
              <div className="AreaPersonale">
                ...
                <Col>
                  ...
                  <Row>Disponibilità: {this.state.utente.disponibilità}</Row>
                </Col>
            ...
            return(
              ...
              <div className="AreaPersonale">
                ...
                <Col>
                  ...
                  <Row>Telefono: {this.state.utente.telefono}</Row>
                </Col>
                </div>
                </div>
                </div>
