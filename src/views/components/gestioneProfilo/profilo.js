...
export default class Profilo extends Component {
  ...
  componentDidMount () {
    axios.post('http://localhost:8080/api/profilo/findByEmail', {
  ...
  render () {
    ...
    if (localStorage.getItem('email') === null) { return (<Redirect to='/login' />) } else if (localStorage.getItem('ruolo') === 'admin') {
      return (
        <div id='root'>
                  ...
                  <div class='row m-l-0 m-r-0'>
                    <div class='col-sm-4 bg-c-lite-green user-profile'>
                      <div class='card-block text-center text-white'>
                        <div class='m-b-25'> <img className='iconaUtente' src='https://img.icons8.com/bubbles/100/000000/under-computer.png' class='img-radius' alt='User-Profile-Image' /> </div>
                        <h6 class='f-w-600 text-uppercase'>{oggetto.nome} {oggetto.cognome}</h6> <br />
                        <h6 class='f-w-600 text-uppercase'>Admin</h6><i class=' mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16' />
                      </div>
                    </div>
                    <div class='col-sm-8'>
              ...
              return (
                <div className='cardProfile user-card-full'>
                  <div class='row m-l-0 m-r-0'>
                    <div class='col-sm-4 bg-c-lite-green user-profile'>
                      <div class='card-block text-center text-white'>
                        <div class='m-b-25'> <img className='iconaUtente' src='https://img.icons8.com/bubbles/100/000000/id-business-man-with-beard.png' class='img-radius' alt='User-Profile-Image' /> </div>
                        <h6 class='f-w-600 text-uppercase'>{oggetto.nome} {oggetto.cognome}</h6><br />
                        <h6 class='f-w-600 text-uppercase'>{oggetto.ruolo}</h6><i class=' mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16' />
                      </div>
                    </div>
                    <div class='col-sm-8'>
                      <div class='card-block'>
              ...
              return (
                <div className='cardProfile user-card-full'>
                  <div class='row m-l-0 m-r-0'>
                    <div class='col-sm-4 bg-c-lite-green user-profile'>
                      <div class='card-block text-center text-white'>
                        <div class='m-b-25'> <img className='iconaUtente' src='https://img.icons8.com/bubbles/100/000000/user.png' class='img-radius' alt='User-Profile-Image' /> </div>
                        <h6 class='f-w-600 text-uppercase'>{oggetto.nome} {oggetto.cognome}</h6><br />
                        <h6 class='f-w-600 text-uppercase'>Cliente</h6><i class=' mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16' />
                      </div>
                    </div>
                    <div class='col-sm-8'>
                      <div class='card-block'>
