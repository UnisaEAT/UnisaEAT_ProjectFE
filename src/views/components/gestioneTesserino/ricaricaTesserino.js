    ...
    render() {
        ...
        return (
            <div id="root">
                ...
                {this.state.popUp && <Popup message={'Ricarica di ' + this.state.importo + ' € effettuata!'}
                    ...
                    <div className="containerRicarica container">
                        <div className="wrapper pagamentoWrapper">
                            ...
                            <div id="tipoCarta" className="form-group">
                                ...
                                <Form.Select id="tipoCarta" name="tipoCarta" onChange={this.onChangeTipoCarta}
                                             defaultValue="">
                            ...
                            <div id="numeroCarta" className="form-group">
                                ...
                                <div className="card-number">
                                    <input name="numeroCarta" id="numeroCarta" type="text"
