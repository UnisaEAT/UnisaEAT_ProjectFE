...
export default class RinnovoTesserino extends Component {
    ...
    submitForm(tesserino) {
        axios.post('http://localhost:8080/api/tesserino/rinnovoTesserino', tesserino)
            .then(response => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.state.popUp && <Popup message="Rinnovo avvenuto con successo" handleClose={this.closePopUp}/>}
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Row className="mb-3">
                            <Form.Group id="nome" as={Col}>
                                ...
                                <Form.Control type="text" id="nome" name="nome" onChange={this.onChangeNome}
                                              placeholder="Inserisci il tuo nome"/>
                            </Form.Group>

                            <Form.Group id="cognome" as={Col}>
                                <Form.Label>Cognome</Form.Label>
                                <Form.Control type="text" id="cognome" name="cognome" onChange={this.onChangeCognome}
                        ...
                        <Row className="mb-3">
                            <Form.Group id="indirizzo" as={Col}>
                                ...
                                <Form.Control type="text" id="indirizzo" name="indirizzo"
                        ...
                        <Row className="mb-3">
                            <Form.Group id="provincia" as={Col}>
                                ...
                                <Form.Control type="text" id="provincia" name="provincia"
                        ...
                        <Row className="mb-3">
                            <Form.Group id="email" as={Col}>
                                ...
                                <Form.Control type="text" id="email" name="email" onChange={this.onChangeEmail}
                        ...
                        <Row className="mb-3">
                            <Form.Group id="confermaEmail" as={Col}>
                                ...
                                <Form.Control type="text" id="confermaEmail" name="confermaEmail"
