                ...
                <form className="form-card" onSubmit="event.preventDefault()">
                    ...
                    <div className="row justify-content-between text-left">
                        <div className="form-group col-sm-6 flex-column d-flex"><label
                            ...
                            className="text-danger"> *</span></label> <input type="text" id="email" name="email"
                    ...
                    <div className="row justify-content-between text-left">
                        <div className="form-group col-sm-6 flex-column d-flex"><label
                            ...
                            <input type="text" id="job" name="job" placeholder="Inserisci Email" onBlur="validate(5)"></input></div>
                    </div>


                        <div className="form-group col-sm-6 flex-column d-flex"><label
                            className="form-control-label px-3">Password<span className="text-danger"> *</span></label>
                            <input type="text" id="job" name="job" placeholder="Inserisci " onBlur="validate(5)"></input></div>
